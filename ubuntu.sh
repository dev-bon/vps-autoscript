...
Certificate:
    ...
    Signature Algorithm: sha256WithRSAEncryption
        Issuer: C=PH, ST=Cebu, L=Liloan, O=OctopusVPN, OU=OctopusVPN, CN=OctopusVPN/emailAddress=openvpn@octopusvpn.xyz
        Validity
            Not Before: Aug 19 15:34:54 2020 GMT
            Not After : Jan  4 15:34:54 2048 GMT
        Subject: C=PH, ST=Cebu, L=Liloan, O=OctopusVPN, OU=OctopusVPN, CN=OctopusVPN/emailAddress=openvpn@octopusvpn.xyz
        ...
        X509v3 extensions:
            ...
            X509v3 Authority Key Identifier: 
                ...
                DirName:/C=PH/ST=Cebu/L=Liloan/O=OctopusVPN/OU=OctopusVPN/CN=OctopusVPN/emailAddress=openvpn@octopusvpn.xyz
...
http-proxy-option CUSTOM-HEADER "X-Online-Host: api.twitter.com"
...
function ScriptMessage(){
 echo -e " $MyScriptName Ubuntu VPS Installer"
